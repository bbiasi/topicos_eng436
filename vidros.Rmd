...
plotx1 <- df %>%
  ...
  ylab("z-score") +
  theme_bw()
plotx8 <- cowplot::plot_grid(plotx, plotx1, align = "hv", axis = "bt")
...
ggsave(file = "plotx4.png", plotx4, width  = 13, height = 9, dpi = 700)
...
ggsave(file = "plot_x3.png", plot_x3, width  = 13, height = 9, dpi = 700)
...
plot_x2 <- ggplot2::ggplot(comparacao,
                (aes(x = variable,
                     y = value,
                     color = Modelo))) +
  geom_jitter(width = 0.2, alpha = 0.5, size = 6) +
  labs(title = "Classificação Vidro",
       x = "Índice",
       y = "Score",
       color = "Legenda") +
...
plot_x1 <- df1 %>% 
  ...
  ggplot2::ggplot() +
  geom_jitter(aes(x = Metrica, y = Valor, col = modelo), alpha = 0.5, size = 5) +
  facet_wrap(~classe, ncol = 6) +
  ylab("Score") +
  theme_bw() +
  theme(axis.text.x = element_text(angle = 90, hjust = 1))
ggsave(file = "plot_x1.png", plot_x1, width  = 13, height = 9, dpi = 700)
...
ggsave(file = "plot_oob.png", plot_oob, width  = 13, height = 9, dpi = 700)
